...
public class Level3 {
    ...
    public static void main(String[] args) {
       List<Teacher> teachers = Data.employees();
        ...
        System.out.println("chaine de caractère qui contient tous les noms des enseignants en majuscule separés : \n"+names);
        /* TO DO 1  hint(reduce)*//*;

        /* TO DO 2: Retourner une set d'enseignants Java dont le salaire > 80000 */
        Set<Teacher> teachers1 = teachers.stream().filter(t->t.getSalary() > 80000 ).filter(t->t.getSubject().equals(Subject.JAVA)).collect(Collectors.toSet());
        System.out.println("set d'enseignants Java dont le salaire > 80000 : "+teachers1);
        ...
        System.out.println("une TreeSet d'enseignants (tri par nom et en cas d'égalité tri par salaire) : " +teachers2);
        ...
        System.out.println("Map qui regroupe les enseignants par module : "+map);
